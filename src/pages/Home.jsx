  ...
  return (
    <div className='grid md:grid-cols-2 h-full p-10 bg-primary/10'>
      <div className='flex flex-col justify-center w-10/12 px-10 ml-10'>
        ...
        <p className='py-7 text-[#5C5C5C]'>KODEX TECHNOLOGY (PVT) LTD is a team of experienced mobile and web applications and website builders measuring dozens of completed projects. We build and develop mobile applications for several top platforms, including Android  & IOS. </p>
